...
public class SpringBootProj11LayeredApplicationProfilesPropertiesFileSingleYmlfileApplication {
	...
	public ComboPooledDataSource createC3P0ds() throws Exception {
		System.out.println("SpringBootProj11LayeredApplication.createC3P0ds()");
	...
	public static void main(String[] args) {
		...
		/*	
		 * // Approach THREE for activating the profiles
		 * SpringApplication application = new SpringApplication(SpringBootProj11LayeredApplicationProfilesPropertiesFileSingleYmlfileApplication.class);
			application.setAdditionalProfiles("dev");
			ApplicationContext ctx = application.run(args);
			*/
		
		ApplicationContext ctx = SpringApplication.run(SpringBootProj11LayeredApplicationProfilesPropertiesFileSingleYmlfileApplication.class, args);
