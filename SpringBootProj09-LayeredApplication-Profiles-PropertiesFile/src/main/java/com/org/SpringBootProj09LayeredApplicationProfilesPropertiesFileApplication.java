...
public class SpringBootProj09LayeredApplicationProfilesPropertiesFileApplication {
	...
	public static void main(String[] args) {
		ApplicationContext ctx = SpringApplication.run(SpringBootProj09LayeredApplicationProfilesPropertiesFileApplication.class, args);
